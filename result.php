...
<head>
  ...
  <style>
    ...
    a { display: inline-block; margin-top: 20px; color: #1e3a8a; text-decoration: none; font-weight: 600; font-size: 14px; }
  </style>
</head>
<body>
  <div class="card">
    ...
    <?php else: ?>
      ...
      <p>Target MX server rejected direct Port 25 socket connection.</p>
    <?php endif; ?>
