...
<head>
  <meta charset="UTF-8">
  <title>Status - BuildMailer</title>
  <style>
...
<body>
  <div class="card">
    <?php if ($status === 'success'): ?>
      ...
      <p>Sent directly to: <strong><?= htmlspecialchars($to) ?></strong></p>
      <p>Configured Reply-To: <strong><?= htmlspecialchars($replyTo) ?></strong></p>
    <?php else: ?>
      <div class="error-icon">✕</div>
      <h2>Delivery Interrupted</h2>
      <p>Unable to establish direct MX socket transmission.</p>
    <?php endif; ?>
